          ...
          children: <Widget>[
            ...
            Row(
              ...
              children: [
                ...
                Text(
                  widget.order?.customerId ?? "Customer Name",
            ...
            ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  final isChecked = selectedReports.contains(reports[index]);
                  return Padding(
                          ...
                          children: <Widget>[
                            Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  color: Colors.white),
                              child: isChecked ? Icon(Icons.check,
                                      color: Color(0xFF252B37), size: 16)
                                  : Container(),
                            ),
                            SizedBox(
            ...
            Center(
              child: InkWell(
                onTap: () {
                  //call api to cancel the order in the backend
                  Navigator.push(
                    context,
